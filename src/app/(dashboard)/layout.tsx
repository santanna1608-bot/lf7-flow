...
export default function DashboardLayout({
  ...
  return (
    <AuthGuard>
      <div className="flex h-screen w-full overflow-hidden bg-background relative text-white">
        ...
        <div className="flex-1 flex flex-col overflow-hidden relative">
          {/* Header Mobile */}
          <header className="lg:hidden flex items-center justify-between px-6 h-16 bg-card border-b border-white/5 shadow-lg z-30 sticky top-0">
            <div className="flex items-center gap-2">
              <div className="h-8 w-8 rounded-lg bg-primary/10 flex items-center justify-center">
                <Zap className="h-5 w-5 text-primary" />
              </div>
              <span className="font-black text-lg tracking-tighter text-white">LF7 AI Flow</span>
            </div>
            <button 
          ...
          <main className="flex-1 overflow-y-auto bg-transparent p-4 lg:p-8 relative">
            {/* Decoração sutil de fundo para o dashboard */}
